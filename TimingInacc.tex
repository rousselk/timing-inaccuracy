...
We discovered that Cooja is absolutely not limited to simulation of
Contiki OS based systems and networks, and routinely used this simulation
framework to perform experiments with another (RIOT) OS.
