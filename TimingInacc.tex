...
layer (PHY) that the involved  WSN nodes communicate on. The maximum
total size for 802.15.4 packets is 127 bytes.}
...
\item the more recent Zolertia Z1 mote powered by a MSP430F2617 MCU.
\end{itemize}
